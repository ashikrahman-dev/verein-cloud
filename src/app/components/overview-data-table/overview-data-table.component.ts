    ...
    template: `
        ...
        >
            ...
            <ng-container matColumnDef="contribution_type">
                ...
                >
                    {{ 'table.contribution_type' | translate }}
                </th>
                <td mat-cell *matCellDef="let element">
            ...
            <ng-container matColumnDef="basic_amount">
                ...
                >
                    {{ 'table.basic_amount' | translate }}
                </th>
                <td mat-cell *matCellDef="let element">
                    $ {{ element.basic_amount }}
                </td>
            </ng-container>
            ...
            <ng-container matColumnDef="booking_account">
                ...
                >
                    {{ 'table.booking_account' | translate }}
                </th>
                <td mat-cell *matCellDef="let element">
...
export class OverviewDataTableComponent {
    ...
    // Add constructor with translation setup
    constructor(private translate: TranslateService) {
        console.log('OverviewDataTableComponent: constructor');
